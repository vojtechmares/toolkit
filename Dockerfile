...
RUN curl -fsSLO curl -fsSLO https://github.com/tailwindlabs/tailwindcss/releases/v${TAILWINDCSS_VERSION}/download/tailwindcss-linux-x64 -o /usr/local/bin/tailwindcss \
